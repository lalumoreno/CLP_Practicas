...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { rtx_i }]; #IO_L17P_T2_34 Sch=JA1_P (Pin 1)
...
# UART
# set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { rxd }]; #IO_L17P_T2_34 Sch=JA1_P