...
HD_PWD='C:/Users/ASUS/Documents/CESE/CLP/Practicas/ALU_4b/ALU_4b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_alu_top_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_alu_top_VIO.tcl -notrace
