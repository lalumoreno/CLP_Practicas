...
HD_PWD='C:/Users/ASUS/Documents/CESE/CLP/Practicas/ALU_4b/ALU_4b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_alu_top_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_alu_top_VIO.tcl
